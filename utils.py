...
try:
	...
	semwordcount[semwithoutends.index("макисэ")]*=8000#Это скорее всего обращение, можно игнорить
	semwordcount[semwithoutends.index("курис")]*=8000#Это скорее всего обращение, можно игнорить
	SEMbuildCache()
except Exception as e:
